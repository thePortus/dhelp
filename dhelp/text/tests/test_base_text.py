...
class TestBaseText(unittest.TestCase):
    ...
    def test_stringify(self):
        ...
        exempla = BaseText("Lorem ipsum dolor sit amet")
    ...
    def test_rm_lines(self):
        ...
        exempla = BaseText("Lorem ipsum dolor\nsit amet")
        comparanda = BaseText("Lorem ipsum dolor sit amet")
        exempla = exempla.rm_lines()
        return self.assertEqual(exempla, comparanda)

    def test_rm_nonchars(self):
        # numbers should be removed
        exempla = BaseText("Lorem1 ipsum2 dolor3 sit4 amet5")
        comparanda = BaseText("Lorem ipsum dolor sit amet")
    ...
    def test_rm_edits(self):
        ...
        exempla = BaseText("Lorem ipsum [dolor] sit amet")
        comparanda = BaseText("Lorem ipsum  sit amet")
